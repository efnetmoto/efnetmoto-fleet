# Xerokewl Data Directory

This directory contains persistent runtime data for the Xerokewl eggdrop bot.

## Files Generated at Runtime

- `eggdrop.conf` - Bot configuration (generated from template by Ansible)
- `Xerokewl.user` - User database
- `Xerokewl.chan` - Channel database
