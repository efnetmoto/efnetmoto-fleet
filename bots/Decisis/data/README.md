# Decisis Data Directory

This directory contains persistent runtime data for the Decisis eggdrop bot.

## Files Generated at Runtime

- `eggdrop.conf` - Bot configuration (generated from template by Ansible)
- `Decisis.user` - User database
- `Decisis.chan` - Channel database
