...
7. **docker-compose-validate** - Ensures compose files parse correctly
8. **template-render-test** - Tests Ansible template rendering (dry run)
...
docker-compose -f bots/Pompone/docker-compose.yml config
